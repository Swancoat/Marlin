...
#define STRING_CONFIG_H_AUTHOR "(Jeremy Swancoat, Seckit SK-GO)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Seckit SK-Go"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  42.6996
    #define DEFAULT_Ki   4.3685
    #define DEFAULT_Kd 104.3419
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 84.8997
  #define DEFAULT_bedKi 11.4691
  #define DEFAULT_bedKd 418.9798
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 25, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -5, -3.3 }
